...
internal const val LEGACY_TABLE_LINK_CAMERA_LENS = "mountables"
internal const val LEGACY_TABLE_LINK_LENS_FILTER = "mountable_filters_lenses"
internal const val ON_UPGRADE_CREATE_FILTER_TABLE = ("create table " + TABLE_FILTERS
        + "(" + KEY_FILTER_ID + " integer primary key autoincrement, "
        + KEY_FILTER_MAKE + " text not null, "
        + KEY_FILTER_MODEL + " text not null"
        + ");")
internal const val ON_UPGRADE_CREATE_LINK_LENS_FILTER_TABLE = ("create table " + LEGACY_TABLE_LINK_LENS_FILTER
        + "(" + KEY_LENS_ID + " integer not null, "
        + KEY_FILTER_ID + " integer not null"
        + ");")
internal const val ALTER_TABLE_FRAMES_1 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_FOCAL_LENGTH + " integer;")
internal const val ALTER_TABLE_FRAMES_2 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_EXPOSURE_COMP + " text;")
internal const val ALTER_TABLE_FRAMES_3 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_NO_OF_EXPOSURES + " integer;")
internal const val ALTER_TABLE_FRAMES_4 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_FLASH_USED + " integer;")
internal const val ALTER_TABLE_FRAMES_5 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_FLASH_POWER + " text;")
internal const val ALTER_TABLE_FRAMES_6 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_FLASH_COMP + " text;")
internal const val ALTER_TABLE_FRAMES_7 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_FRAME_SIZE + " text;")
internal const val ALTER_TABLE_FRAMES_8 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_FILTER_ID + " integer;")
internal const val ALTER_TABLE_FRAMES_9 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_METERING_MODE + " integer;")
internal const val ALTER_TABLE_FRAMES_10 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_FORMATTED_ADDRESS + " text;")
internal const val ALTER_TABLE_FRAMES_11 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_PICTURE_FILENAME + " text;")
internal const val ALTER_TABLE_FRAMES_12 = ("ALTER TABLE " + TABLE_FRAMES
        + " ADD COLUMN " + KEY_LIGHT_SOURCE + " integer;")
internal const val ALTER_TABLE_LENSES_1 = ("ALTER TABLE " + TABLE_LENSES
        + " ADD COLUMN " + KEY_LENS_MAX_APERTURE + " text;")
internal const val ALTER_TABLE_LENSES_2 = ("ALTER TABLE " + TABLE_LENSES
        + " ADD COLUMN " + KEY_LENS_MIN_APERTURE + " text;")
internal const val ALTER_TABLE_LENSES_3 = ("ALTER TABLE " + TABLE_LENSES
        + " ADD COLUMN " + KEY_LENS_MAX_FOCAL_LENGTH + " integer;")
internal const val ALTER_TABLE_LENSES_4 = ("ALTER TABLE " + TABLE_LENSES
        + " ADD COLUMN " + KEY_LENS_MIN_FOCAL_LENGTH + " integer;")
internal const val ALTER_TABLE_LENSES_5 = ("ALTER TABLE " + TABLE_LENSES
        + " ADD COLUMN " + KEY_LENS_SERIAL_NO + " text;")
internal const val ALTER_TABLE_LENSES_6 = ("ALTER TABLE " + TABLE_LENSES
        + " ADD COLUMN " + KEY_LENS_APERTURE_INCREMENTS + " integer not null default 0;")
internal const val ALTER_TABLE_CAMERAS_1 = ("ALTER TABLE " + TABLE_CAMERAS
        + " ADD COLUMN " + KEY_CAMERA_MAX_SHUTTER + " text;")
internal const val ALTER_TABLE_CAMERAS_2 = ("ALTER TABLE " + TABLE_CAMERAS
        + " ADD COLUMN " + KEY_CAMERA_MIN_SHUTTER + " text;")
internal const val ALTER_TABLE_CAMERAS_3 = ("ALTER TABLE " + TABLE_CAMERAS
        + " ADD COLUMN " + KEY_CAMERA_SERIAL_NO + " text;")
internal const val ALTER_TABLE_CAMERAS_4 = ("ALTER TABLE " + TABLE_CAMERAS
        + " ADD COLUMN " + KEY_CAMERA_SHUTTER_INCREMENTS + " integer not null default 0;")
internal const val ALTER_TABLE_CAMERAS_5 = ("ALTER TABLE " + TABLE_CAMERAS
        + " ADD COLUMN " + KEY_CAMERA_EXPOSURE_COMP_INCREMENTS + " integer not null default 0;")
internal const val ALTER_TABLE_CAMERAS_6 = ("ALTER TABLE " + TABLE_CAMERAS
        + " ADD COLUMN " + KEY_LENS_ID + " integer references " + TABLE_LENSES + " on delete set null;")
internal const val ALTER_TABLE_ROLLS_1 = ("ALTER TABLE " + TABLE_ROLLS
        + " ADD COLUMN " + KEY_ROLL_ISO + " integer;")
internal const val ALTER_TABLE_ROLLS_2 = ("ALTER TABLE " + TABLE_ROLLS
        + " ADD COLUMN " + KEY_ROLL_PUSH + " text;")
internal const val ALTER_TABLE_ROLLS_3 = ("ALTER TABLE " + TABLE_ROLLS
        + " ADD COLUMN " + KEY_ROLL_FORMAT + " integer;")
internal const val ALTER_TABLE_ROLLS_4 = ("ALTER TABLE " + TABLE_ROLLS
        + " ADD COLUMN " + KEY_ROLL_ARCHIVED + " integer not null default 0;")
internal const val ALTER_TABLE_ROLLS_5 = ("ALTER TABLE " + TABLE_ROLLS
        + " ADD COLUMN " + KEY_FILM_STOCK_ID + " integer references " + TABLE_FILM_STOCKS + " on delete set null;")
internal const val ALTER_TABLE_ROLLS_6 = ("ALTER TABLE " + TABLE_ROLLS
        + " ADD COLUMN " + KEY_ROLL_UNLOADED + " text;")
internal const val ALTER_TABLE_ROLLS_7 = ("ALTER TABLE " + TABLE_ROLLS
        + " ADD COLUMN " + KEY_ROLL_DEVELOPED + " text;")
internal const val REPLACE_QUOTE_CHARS = ("UPDATE " + TABLE_FRAMES
...
internal const val ROLLS_TABLE_REVISION_2 = ("create table " + TABLE_ROLLS
        ...
        + ");")
internal const val ROLLS_TABLE_REVISION_3 = ("insert into " + TABLE_ROLLS + " ("
...
internal const val FRAMES_TABLE_REVISION_2 = ("create table " + TABLE_FRAMES
        ...
        + ");")
internal const val FRAMES_TABLE_REVISION_3 = ("insert into " + TABLE_FRAMES + " ("
...
internal const val ON_UPGRADE_CREATE_LINK_FRAME_FILTER_TABLE = ("create table " + TABLE_LINK_FRAME_FILTER
        ...
        + ");")
internal const val FRAMES_TABLE_REVISION_4 = ("insert into " + TABLE_LINK_FRAME_FILTER + " ("
...
internal const val CAMERA_LENS_LINK_TABLE_REVISION_2 = ("create table " + TABLE_LINK_CAMERA_LENS
        ...
        + ");")
internal const val CAMERA_LENS_LINK_TABLE_REVISION_3 = ("insert into " + TABLE_LINK_CAMERA_LENS + " ("
...
// (2) create a new table with new structure,
// (3) insert data from the renamed table to the new table and (4) drop the renamed table.
internal const val LENS_FILTER_LINK_TABLE_REVISION_1 = "alter table $LEGACY_TABLE_LINK_LENS_FILTER rename to temp_mountable_filters_lenses;"
internal const val LENS_FILTER_LINK_TABLE_REVISION_2 = ("create table " + TABLE_LINK_LENS_FILTER
        + "(" + KEY_LENS_ID + " integer not null references " + TABLE_LENSES + " on delete cascade, "
        + KEY_FILTER_ID + " integer not null references " + TABLE_FILTERS + " on delete cascade, "
        + "primary key(" + KEY_LENS_ID + ", " + KEY_FILTER_ID + ")"
        + ");")
internal const val LENS_FILTER_LINK_TABLE_REVISION_3 = ("insert into " + TABLE_LINK_LENS_FILTER + " ("
