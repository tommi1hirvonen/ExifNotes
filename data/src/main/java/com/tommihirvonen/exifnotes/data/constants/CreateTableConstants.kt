...
internal const val CREATE_FILM_STOCKS_TABLE = ("create table " + TABLE_FILM_STOCKS
...
internal const val CREATE_LENS_TABLE = ("create table " + TABLE_LENSES
...
internal const val CREATE_CAMERA_TABLE = ("create table " + TABLE_CAMERAS
...
internal const val CREATE_FILTER_TABLE = ("create table " + TABLE_FILTERS
        + "(" + KEY_FILTER_ID + " integer primary key autoincrement, "
        + KEY_FILTER_MAKE + " text not null, "
        + KEY_FILTER_MODEL + " text not null"
        + ");")

internal const val CREATE_ROLL_TABLE = ("create table " + TABLE_ROLLS
...
internal const val CREATE_LINK_CAMERA_LENS_TABLE = ("create table " + TABLE_LINK_CAMERA_LENS
...
internal const val CREATE_LINK_LENS_FILTER_TABLE = ("create table " + TABLE_LINK_LENS_FILTER
        + "(" + KEY_LENS_ID + " integer not null references " + TABLE_LENSES + " on delete cascade, "
        + KEY_FILTER_ID + " integer not null references " + TABLE_FILTERS + " on delete cascade, "
        + "primary key(" + KEY_LENS_ID + ", " + KEY_FILTER_ID + ")"
        + ");")

internal const val CREATE_LINK_FRAME_FILTER_TABLE = ("create table " + TABLE_LINK_FRAME_FILTER
